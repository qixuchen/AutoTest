...
# ../sherlock-project/sherlock-project/sherlock/features/bag_of_characters.py:38: FutureWarning: Possible nested set at position 1
...
def generate_chars_col():
    idx = 0
    with open("./sherlock-project/sherlock/features/feature_column_identifiers/char_col.tsv", "w") as char_col:
